...
# write.csv(wxstn_df, "../nbcclimate/data/wxstn_df.csv", row.names = FALSE)
# write.csv(wind_df, "../nbcclimate/data/wind_df.csv", row.names = FALSE)
# write.csv(rt, "../nbcclimate/data/real_time_stn.csv", row.names = FALSE)
# write.csv(wxstn_sites, "../nbcclimate/data/wxstn_sites.csv", row.names = FALSE)
# write.csv(annual_sum, "../nbcclimate/data/annual_sum.csv", row.names = FALSE)
# write.csv(monthly_sum, "../nbcclimate/data/monthly_sum.csv", row.names = FALSE)
# write.csv(month_year_sum, "../nbcclimate/data/month_year_sum.csv", row.names = FALSE)
# write.csv(seasonal_sum, "../nbcclimate/data/seasonal_sum.csv", row.names = FALSE)
# write.csv(gseason_sum, "../nbcclimate/data/gseason_sum.csv", row.names = FALSE)
