...
updates <- dir("Z:/!Workgrp/Research/JWang/WxUpdates_Hly2018/csv/", pattern = "csv")
...
for (i in 1:length(updates)) {
  df <- read_csv(paste0("Z:/!Workgrp/Research/JWang/WxUpdates_Hly2018/csv/", updates[i]))
  df_orig <- read_csv(paste0("Z:/!Workgrp/Research/JWang/ClimateData/WxStns/csv/hourly/", originals[i]))
